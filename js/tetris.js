document.addEventListener('DOMContentLoaded',()=>{
	...
	// Moving tetromino right and prevent collisions with shapes while moving
	function moveRight() {
		undraw();
	...
	// Show tetromino is display sqaures
	...
	// Add Score
	function addScore() {
		for(currentIndex = 0; currentIndex < 199; current += width) {
			 ...
			 if(row.every(index => squares[index].classList.contains('block2'))) {
			 	...
			 	// Splice Array
			 	const squaresRemoved = squares(currentIndex, width);
